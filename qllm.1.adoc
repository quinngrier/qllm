...
:x_atatat_gt: pass:n[**@@@>**]
:x_atatat_lt: pass:n[**@@@<**]
:x_atatat_ltlt: pass:n[**@@@<<**]
:x_brackets: pass:n[**++[]++**]
:x_dotdot: pass:n[**..**]
:x_foo: pass:n[**foo**]
:x_foo_slash_star: pass:n[**++foo/*++**]
...
.Example {counter:x_example_number}
----
...
will be used.
For example, only {x_var_VISUAL_BOTTOM} will be used if you're using
{x_var_VISUAL}.
+
If this variable is unset, it will be inferred if your text editor is
exactly {x_vi} or {x_vim}.
...
This also applies if you're letting your text editor default to {x_vi}.
